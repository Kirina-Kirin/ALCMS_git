 ...
 <body>
		...
		<table cellspacing="0" cellpadding="0" class='signup'>
		   <col style="width:30%">
			...
			<tbody>
		<tr>
			<td> <label for="idsignup" class="youid"> Student ID  </label></td>
		...
		<tr>
		<td colspan="2">
			<input type="submit" value="Submit" /> <input type="button" onclick="backToPage('page_student_account.php');" value="Cancel" />
		</td>
		<td> 
		</td>
		</tr>
